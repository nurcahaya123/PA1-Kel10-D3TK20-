<?php
$title = "website wisata sumut | Buat Artikel";
...
if (isset($_POST["saveArtikel"])) {
    ...
    if (addArtikelUS($_POST) > 0) {
        echo "
      <script>
        alert('Data berhasil disimpan. Data anda sedang menunggu persetujuan dari pihak Admin sebelum dipublikasi');
...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/website-wisata-sumut/assets/fontawesome-free/css/all.min.css">
        ...
        <img src="assets/img/about/logo_web.png" alt="" style="width: 150px;">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav text-uppercase ml-auto">
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger" href="index.php?#artikel">Info Wisata</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger" href="#">Tambah Artikel Wisata</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container">
        <div class="card card-primary border shadow-lg mb-3">
            <div class="card-header bg-info">
                <h3 class="card-title text-white">Form Penambahan Artikel</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
