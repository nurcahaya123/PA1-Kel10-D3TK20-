<?php
$title = "website wisata sumut | Tempat Wisata";
...
<head>
    ...
    <script src="http://localhost/website-wisata-sumut/assets/ckeditor/ckeditor.js"></script>
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" style="height: 100px;">
        <div class="container">
        <img src="assets/img/about/logo_web.png" alt="" style="width: 150px;">
            <a class="navbar-brand js-scroll-trigger text-tebal" href="#page-top">Home</a>
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav text-uppercase ml-auto">
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger align-content-center" href="#artikel">Info Wisata</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger" href="buatArtikel.php">Tambahkan Artikel Wisata</a>
                    </li>
                    <li class="nav-item">
            ...
            <form action="" method="post" class=" pt-1 d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0">
                <div class="input-group">
                    <input type="text" class="form-control" placeholder="cari" aria-label="Search" aria-describedby="basic-addon2" name="katakunci">
    ...
    <!-- Header -->
    <header class="masthead" style="height: 700px;">
        <div class="container">
            <div class="intro-text">
                <div class="intro-lead-in pt-5 mt-5 text-green">Find your Destination</div>
            </div>
        </div>
    </header>
        ...
        <div class="container">
            <div class="row mb-3">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading text-uppercase text-white">Info Artikel Wisata Terbaru</h2>
                    <hr>
                </div>
            </div>
            <div class="row">
    ...
    <footer class="footer bg-dark">
        <div class="container">
            <div class="text-center">
                <span class="copyright text-white">Copyright &copy; Kelompok 10 D3TK20 <?= date('Y'); ?></span>
            </div>
        </div>
    </footer>
